...
library(psych)
#Fuzzy C-Means
res.fcm <- fcm(dataleasing, centers=2, dmetric="euclidean")
...
icdrate(dataleasing1,length(dataleasing1),2)

#==================GUSTAFSON KESSEL CLUSTERING=========================
#Gustafson Kessel
cl.gk=gk(dataleasing, 2, m=2, dmetric="euclidean")
cl.gk
#Fuzzy Membership Matrix
...
icdrate(dataleasing2,length(dataleasing2),2)
