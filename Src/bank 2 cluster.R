...
library(psych)
#Fuzzy C-Means
res.fcm <- fcm(databank, centers=2, dmetric="euclidean")
...
cluster::clusplot(scale(databank), res.fcm3$cluster,
                  main = "Perbankan Cmeans 2 Cluster",
...
icdrate(databank1,length(databank1),2)

#==================GUSTAFSON KESSEL CLUSTERING=========================
#Gustafson Kessel
cl.gk=gk(databank, 2, m=2, dmetric="euclidean")
cl.gk
#Fuzzy Membership Matrix
...
icdrate(databank2,length(databank2),2)
