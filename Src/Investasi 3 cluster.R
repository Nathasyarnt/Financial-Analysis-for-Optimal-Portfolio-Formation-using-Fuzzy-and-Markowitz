...
library(psych)
#Fuzzy C-Means
res.fcm <- fcm(datajinves, centers=3, dmetric="euclidean")
...
icdrate(datajinves1,length(datajinves1),3)

#==================GUSTAFSON KESSEL CLUSTERING=========================
#Gustafson Kessel
cl.gk=gk(datajinves, 3, m=3, dmetric="euclidean")
cl.gk
#Fuzzy Membership Matrix
...
icdrate(datajinves2,length(datajinves2),3)
